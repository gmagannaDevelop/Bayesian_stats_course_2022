...
# test1 and test2 CRI include zero, which is logical given that the hypotheses are actually true.
# (that said to be better interpreted these statistics could be normalized, i.e. divided by some stuff)

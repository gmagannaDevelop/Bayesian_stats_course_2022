...
This analysis is arbitrary and has the sole purpose of being able to do a 
"nice" ANOVA, on  quasi-gaussian data.
...
cat(file = "model_lmm.txt",glue("
    model {

    # Priors
    mu ~ dnorm(0, 0.001) # Intercept
    #for(i in 1:{{nrow(bdatal$LC)}}){
    for(i in 1:M){
      # Random site effects
...
denplot(out_lmm3, parms = c("sd","sd.site"))
